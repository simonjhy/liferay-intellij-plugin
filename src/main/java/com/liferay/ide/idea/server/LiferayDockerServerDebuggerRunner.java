...
public class LiferayDockerServerDebuggerRunner
	...
	protected RunContentDescriptor createContentDescriptor(
		...
		if (state instanceof ExternalSystemRunConfiguration.MyRunnableState) {
			ExternalSystemRunConfiguration.MyRunnableState myRunnableState =
				(ExternalSystemRunConfiguration.MyRunnableState)state;
			...
			_logger.warn(
				String.format(
					...
					ExternalSystemRunConfiguration.MyRunnableState.class.getName(), runProfileStateClass.getName()));
		}
	...
	private RunContentDescriptor _getRunContentDescriptor(
			@NotNull ExternalSystemRunConfiguration.MyRunnableState state, @NotNull ExecutionEnvironment environment,
			int port)
		throws ExecutionException {
